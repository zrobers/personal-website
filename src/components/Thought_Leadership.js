...
const ThoughtLeadership = () => {
  const articles = [
    {
      id: 1,
      title: 'Sparsity and Skew: The Role of Bad Data in the Prominence of the Classics',
      image: '/images/article-images/sparsity_and_skew.png',
      link: '/thought-leadership/sparsity-skew',
    },
    {
      id: 2,
      title: 'Deriving the Riemann-Siegel Formula with the Method of Steepest Descent',
      image: '/images/article-images/riemann_siegel.png',
      link: '/thought-leadership/riemann-siegel',
    },
    {
      id: 3,
      title: 'Exploring the Efficiency of GOSDT',
      image: '/images/article-images/decision_tree.png',
      link: '/thought-leadership/gosdt-efficiency',
    },
    {
      id: 4,
